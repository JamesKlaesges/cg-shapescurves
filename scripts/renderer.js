class Renderer {
    ...
    drawBezierCurve(pt0, pt1, pt2, pt3, color, framebuffer) {
        ...
        var t = increment;
        this.drawRectangle({x: pt1.x-2, y: pt1.y-2}, {x: pt1.x+2, y: pt1.y+2}, color, framebuffer) {
        this.drawRectangle({x: pt2.x-2, y: pt2.y-2}, {x: pt2.x+2, y: pt2.y+2}, color, framebuffer) {
        for (var i=0; i<num_points; i++){
